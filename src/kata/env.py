...
class KataEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.assigned_tickets["time_to_complete"][action] = self.current_ticket["time_to_complete"]
        ...
        self.assigned_tickets["type_of_failure"][action] = self.current_ticket["type_of_failure"]
