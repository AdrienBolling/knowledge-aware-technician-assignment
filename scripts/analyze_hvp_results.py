...
AGENT_LABELS = {
    ...
    # Architecture ladder: same PPO recipe, only the encoder changes.
    "ladder_flat": r"Ladder-Flat (abl.)",
    "ladder_flat_last": r"Ladder-Flat-last (abl.)",
    "ladder_pool": r"Ladder-Pool (abl.)",
    "ladder_pool_last": r"Ladder-Pool-last (abl.)",
    "ladder_plainset": r"Ladder-PlainSet (abl.)",
    "ladder_plainset_last": r"Ladder-PlainSet-last (abl.)",
    "hc_perm_dgy": r"HTT-RL-perm (ours)",
    "hc_perm_dgy_last": r"HTT-RL-perm-last (ours)",
