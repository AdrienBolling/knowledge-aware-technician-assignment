...
AGENT_LABELS = {
    ...
    "ft_quality_live_sto": r"v6-ft-quality-live-sto (ours)",
    "ft_quality_live_det": r"v6-ft-quality-live-det (ours)",
    "ft_quality_s5ft": r"v6-ft-quality-s5ft (ours)",
    "ft_quality_sto": r"v6-ft-quality-sampled (ours)",
